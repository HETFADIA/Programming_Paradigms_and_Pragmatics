...
public class TwoPlayers {
    ...
    void instructions() {
        ...
        System.out.println("There are two type in this game");
        System.out.println("Type 1: Player plays against another player(Two players)");
        System.out.println("Type 2: Player plays against computer");
        System.out.println("Enter 1 to play type 1 and 2 to play type 2");
        System.out.print("Enter type which you want to play:");
    }
